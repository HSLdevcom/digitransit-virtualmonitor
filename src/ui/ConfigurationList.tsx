...
const ConfigurationList = ({
  t,
}: IConfigurationListProps & WithTranslation) => (
      ...
      if (!result || !result.data) {
        return (
          <div>
            ...
            {result.error ? result.error.message : 'Weird...'}
          </div>
        );
      }
      if (
        ...
        (!result.data.localConfigurations ||
          result.data.localConfigurations.length <= 0)
      ) {
