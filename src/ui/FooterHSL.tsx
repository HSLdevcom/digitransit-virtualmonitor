  ...
  const data: Record<'fi' | 'sv' | 'en', FooterData> = {
      ...
      column1: {
        ...
        links: [
          ...
          { label: 'Linjat ja kartta', href: `${baseUrl}/linjat-ja-kartta` },
      ...
      column3: {
        ...
        links: [
          ...
          { label: 'Avoimet työpaikat', href: `${baseUrl}/avoimet-tyopaikat` },
    ...
    sv: {
      ...
      column3: {
        ...
        links: [
          ...
          { label: 'Lediga tjänster', href: `${baseUrl}/sv/lediga-tjanster` },
      ...
      secondaryLinks: {
        ...
        paymentMethodsLink: { href: `${baseUrl}/sv/biljetter/betalningssatt` },
        ...
        accessibilityStatementLink: { href: `${baseUrl}/sv/tillganglighet` },
      },
    },
    en: {
      column1: {
        title: 'Travelling',
        links: [
          { label: 'Journey planner', href: `${baseUrl}/en/journey-planner` },
