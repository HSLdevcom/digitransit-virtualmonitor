...
import { DaySeconds, EpochSecondsLocal, Seconds } from '../time';
...
export type StopTimesRetrieverQueryResult = QueryResult<
  IStopTimesResponse,
  IStopTimesQuery
>;
...
const StopTimesRetriever: React.StatelessComponent<IStopTimesRetrieverProps> = (
  props: IStopTimesRetrieverProps,
) => (
    ...
    {({ reittiOpas }) => (
      <StopTimesQuery
        ...
        variables={{
          ...
          numberOfDepartures: 10 /*props.displayedRoutes as number*/,
        }}
        pollInterval={20000}
      >
        {props.children}
